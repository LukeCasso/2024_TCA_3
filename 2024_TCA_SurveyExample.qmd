...
This section investigates the relationships between two paired numerical variables. We will use Pearson's correlation coefficient to assess the strength of the relationship.

Let use linear regression to determine correlation between X and Y.
